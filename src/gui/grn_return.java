 ...
 * @author Pronet
 */
public class grn_return extends javax.swing.JFrame {
    
    public static HashMap<String, GrnReturn> grnreturnmap = new HashMap<>();
...
//    }
    ...
    private void loadgrnreturn() {
        // SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");

        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
        dtm.setRowCount(0);
        int total = 0;
        for (GrnReturn invoicreturn : grnreturnmap.values()) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        GrnReturn grn = new GrnReturn();
        grn.setStockid(id);
        grn.setName(name);
        grn.setBrand(brand);
        grn.setPrice(Double.parseDouble(price));
        grn.setQty(Integer.parseInt(qty));
        if (grnreturnmap.get(id) == null) {
           grnreturnmap.put(id, grn);
            
        } else {
            GrnReturn found = grnreturnmap.get(id);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (name.isEmpty()) {
            ...
            for (GrnReturn retu : grnreturnmap.values()) {
                
                try {
                    MySql.execute("INSERT INTO `grn_return` (`unique_id`,`qty`,`remarks`,`date`,`supplier_mobile`,`stock_id`) VALUES ('" + id + "','" + retu.getQty() + "','" + remarks + "','" + datetime + "','" + supplier + "','" + retu.getStockid() + "')");
...
//            java.util.logging.Logger.getLogger(grn_return.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                grn_return dialog = new grn_return(new javax.swing.JFrame(), true);
